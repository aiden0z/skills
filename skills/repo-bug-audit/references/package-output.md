...
Append exactly one attribution line at the very end of `submit/README.md`, after a `---` separator. Same wording every package — short, factual, linked.
...
Constraints:
- Exactly one line, exactly at the README end. Do not also add it to per-Bug docs, indexes, or knowledge files — that is noise.
